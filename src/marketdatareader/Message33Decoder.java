...
class Message33Decoder {
    ...
    public Message33Decoder(byte[] message, final byte[] messageCount, int bufferOffset, int actingBlockLength, int actingVersion, String queue) {
    ...
    private void decode() {
       ...
       for(final MDIncrementalRefreshDailyStatistics33.NoMDEntries noMDEntries : marketData.noMDEntries())
       {
           ...
           sbmd.append("\"[731]=\"").append(noMDEntries.settlPriceType());           
