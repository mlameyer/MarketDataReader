...
import mktdata.MDIncrementalRefreshLimitsBanding34;
 ...
 */
class Message34Decoder {
    private final MDIncrementalRefreshLimitsBanding34 marketData = new MDIncrementalRefreshLimitsBanding34();
    ...
    public Message34Decoder(byte[] message, final byte[] messageCount, int bufferOffset, int actingBlockLength, int actingVersion, String queue) {
    ...
    private void decode() {
       ...
       for(final MDIncrementalRefreshLimitsBanding34.NoMDEntries noMDEntries : marketData.noMDEntries())
       {
           sbmd.append("\"[1149]=\"").append(noMDEntries.highLimitPrice());
           sbmd.append("\"[1148]=\"").append(noMDEntries.lowLimitPrice()); 
           sbmd.append("\"[1143]=\"").append(noMDEntries.maxPriceVariation());
