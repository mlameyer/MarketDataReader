...
class Message36Decoder {
    ...
    public Message36Decoder(byte[] message, final byte[] messageCount, int bufferOffset, int actingBlockLength, int actingVersion, String queue) {
    ...
    private void decode() {
       ...
       for(final MDIncrementalRefreshTrade36.NoMDEntries noMDEntries : marketData.noMDEntries())
       {
           ...
           sbmd.append("\"[1003]=\"").append(noMDEntries.tradeID()); 
           sbmd.append("\"[5797]=\"").append(noMDEntries.aggressorSide()); 
