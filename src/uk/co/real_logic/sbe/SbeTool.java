...
public class SbeTool
{
    ...
    public static void main(final String[] args) throws Exception
    {
        ...
        */
        ...
        //a = getFile();
        //a[0] = "C:\\Users\\Administrator\\Documents\\NetBeansProjects\\SbeTool\\templates_FixBinary.xml";
        a[0] = "C:\\SbeTool\\templates_FixBinary.xml";
        System.out.println(a[0]);

        for (final String fileName : a)
        {
            final Ir ir;
    ...
    private static String[] getFile() {
		...
		try {
			...
			br = new BufferedReader(new FileReader("C:\\Users\\bgilbert\\Documents\\NetBeansProjects\\SBETool\\templates_FixBinary.xml"));
