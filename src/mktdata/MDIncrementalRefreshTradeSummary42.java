...
public class MDIncrementalRefreshTradeSummary42
{
    ...
    public MDIncrementalRefreshTradeSummary42 wrapForEncode(final DirectBuffer buffer, final int offset)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public MDIncrementalRefreshTradeSummary42 wrapForDecode(
    ...
    public MDIncrementalRefreshTradeSummary42 transactTime(final long value)
    {
    ...
    public static class NoMDEntries implements Iterable<NoMDEntries>, java.util.Iterator<NoMDEntries>
    {
        ...
        private MDIncrementalRefreshTradeSummary42 parentMessage;
        private DirectBuffer buffer;
        ...
        public void wrapForDecode(
            final MDIncrementalRefreshTradeSummary42 parentMessage, final DirectBuffer buffer, final int actingVersion)
        {
        ...
        public void wrapForEncode(final MDIncrementalRefreshTradeSummary42 parentMessage, final DirectBuffer buffer, final int count)
        {
            this.parentMessage = parentMessage;
            this.buffer = buffer;
