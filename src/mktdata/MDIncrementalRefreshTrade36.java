...
public class MDIncrementalRefreshTrade36
{
    ...
    private final MDIncrementalRefreshTrade36 parentMessage = this;
    ...
    public MDIncrementalRefreshTrade36 wrapForEncode(final DirectBuffer buffer, final int offset)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public MDIncrementalRefreshTrade36 wrapForDecode(
    ...
    public MDIncrementalRefreshTrade36 transactTime(final long value)
    {
    ...
    public static class NoMDEntries implements Iterable<NoMDEntries>, java.util.Iterator<NoMDEntries>
    {
        ...
        private MDIncrementalRefreshTrade36 parentMessage;
        private DirectBuffer buffer;
        ...
        public void wrapForDecode(
            final MDIncrementalRefreshTrade36 parentMessage, final DirectBuffer buffer, final int actingVersion)
        {
        ...
        public void wrapForEncode(final MDIncrementalRefreshTrade36 parentMessage, final DirectBuffer buffer, final int count)
        {
            this.parentMessage = parentMessage;
            this.buffer = buffer;
        ...
        public NoMDEntries tradeID(final int value)
        {
        ...
        {
            return AggressorSide.get(CodecUtil.uint8Get(buffer, offset + 28));
        }
        ...
        {
            return MDUpdateAction.get(CodecUtil.uint8Get(buffer, offset + 29));
        }
