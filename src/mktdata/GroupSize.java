...
public class GroupSize
{
    ...
    public GroupSize wrap(final DirectBuffer buffer, final int offset, final int actingVersion)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public GroupSize blockLength(final int value)
    {
    ...
    public GroupSize numInGroup(final short value)
    {
